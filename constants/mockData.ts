...
export const mockData: Record<CategoryListType['name'], PreviewCardTypes[]> = {
  ...
  category2: [
    {
      title: 'mock daat 2-1',
      description: 'mock data 2-1 description',
      imageUrl: '',
      tags: ['PM', 'UI/UX', 'Front-end', 'Back-end'],
      isSoftDelete: false,
      githubUrl: 'https://github.com/side-project-taiwan/sideproj.tw',
    ...
    {
      title: 'mock daat 2-2',
      description: 'mock data 2-2 description',
      imageUrl: '',
      tags: ['PM', 'UI/UX', 'Front-end', 'Back-end'],
      isSoftDelete: false,
      githubUrl: 'https://github.com/side-project-taiwan/member',
    ...
    {
      title: 'mock daat 2-3',
      description: 'mock data 2-3 description',
      imageUrl: '',
      tags: [
        'PM',
        'UI/UX',
    ...
    {
      title: 'mock daat 2-4',
      description: 'mock data 2-4 description',
      imageUrl: '',
      tags: [
        'PM',
        'UI/UX',
  ...
  category3: [
    {
      title: 'mock daat 3-1',
      description: 'mock data 3-1 description',
      imageUrl: '',
      tags: ['PM', 'UI/UX', 'Front-end', 'Back-end'],
      isSoftDelete: false,
      githubUrl: 'https://github.com/side-project-taiwan/sideproj.tw',
    ...
    {
      title: 'mock daat 3-2',
      description: 'mock data 3-2 description',
      imageUrl: '',
      tags: ['PM', 'UI/UX', 'Front-end', 'Back-end'],
      isSoftDelete: false,
      githubUrl: 'https://github.com/side-project-taiwan/member',
    ...
    {
      title: 'mock daat 3-3',
      description: 'mock data 3-3 description',
      imageUrl: '',
      tags: [
        'PM',
        'UI/UX',
    ...
    {
      title: 'mock daat 3-4',
      description: 'mock data 3-4 description',
      imageUrl: '',
      tags: [
        'PM',
        'UI/UX',
